        ...
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            ...
            <a
              ...
              href="/"
            >
              <img className=' object-cover' src="https://dl.dropboxusercontent.com/scl/fi/ntt2icdo7eghjnr512mm5/logo.svg?rlkey=9e2oayovjnlifyprbixrn3e82&st=89mshxfd&dl=0" width={140} />
            </a>
            {/*      <!-- Mobile trigger --> */}
            <button
