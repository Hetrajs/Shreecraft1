...
const Products = () => {
  ...
  useGSAP(() => {
    ...
    // Disable sessionStorage caching
    ...
    <>
      <section ref={BGColor} id="products" className="relative overflow-hidden bg-black">
        <div className="container mx-auto px-6 py-16 max-w-[1300px] w-full">
          <div className="bg-black p-8 lg:py-16 flex w-full flex-col rounded-[20px] gap-8 justify-center items-center lg:gap-16">
            <div className="our_products">
              <h1 ref={BIGText} className="text-[#333333] top-[100px] -left-0 font-bold font-inter lg:leading-[170px] text-[90px] leading-[90px] tracking-tighter lg:text-[200px] absolute">Our <br /> Products </h1>
              <div id="photos" className="w-full relative z-[2] grid mx-auto justify-center items-center lg:grid-cols-2 gap-5">
                <div ref={LeftImage} className="w-full overflow-hidden space-y-2">
                  <img
                ...
                <div className="w-full flex flex-col justify-center items-center gap-5">
                  <div ref={TopImage} className="w-full space-y-2">
                    <img
                  ...
                  <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-5 xl:gap-10">
                    <div ref={BottomImage} className="overflow-hidden w-full space-y-2">
                      <img
                    ...
                    <div ref={RightImage} className="overflow-hidden w-full space-y-2">
                      <img
                        className="max-w-[400px] lg:max-w-[550px] w-full rounded-[9px] object-cover lg:object-[20%] h-[200px] lg:h-[270px]"
              ...
              <Link
                className="bg-white block mt-20 mx-auto w-fit text-center px-7 py-3 rounded-full font-inter"
                to="/products"
              >
                View All
              </Link>
